...
const FEATURED_PROJECTS: Project[] = [
  {
    title: 'Tienda CapiShop',
    summary: 'E-commerce de tecnología sostenible',
    description:
      'Plataforma de venta online con experiencia inmersiva, checkout optimizado y gestión de inventario en tiempo real. Integración con pasarelas de pago y CMS headless para actualizaciones ágiles.',
    ...
    visual: {
      gradient:
        'linear-gradient(135deg, #4338CA 0%, #14B8A6 50%, #8B5CF6 100%)',
      pattern:
      ...
      image: '/capishop.com.png',
    },
  },
  {
    title: 'Tienda PijamaCandy',
    summary: 'Ecommerce de ropa de dormir para damas',
    description:
    ...
    tech: ['React', 'Next.js', 'TypeScript', 'PostgreSQL', 'Tailwind'],
    metrics:
      'gran mejora en el tiempo de decisión gracias a insights automatizados',
    links: {
      live: 'https://pijamacandy-com.vercel.app/',
      repo: 'https://github.com/basabecode',
    },
    badge: 'Caso de éxito',
    visual: {
      gradient:
        'linear-gradient(140deg, #111827 0%, #1E293B 35%, #38BDF8 100%)',
      pattern:
      ...
      image: '/pijama.com.png',
    },
  },
  {
    title: 'Tienda RockBros Store',
    summary: 'E-commerce para equipamiento de ciclismo',
    description:
    ...
    tech: ['Vite', 'OpenAI', 'Supabase', 'React', 'Supabase'],
    metrics: 'mas visitas debido al uso de IA en la busqueda de productos',
    links: {
      live: 'https://rockbrosstore.vercel.app/',
      repo: 'https://github.com/basabecode',
    },
    badge: 'Innovación',
    visual: {
      gradient:
        'linear-gradient(140deg, #7C3AED 0%, #DB2777 45%, #F97316 100%)',
      pattern:
...
const ADDITIONAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    visual: {
      gradient:
        'linear-gradient(135deg, #0F172A 0%, #2563EB 45%, #14B8A6 100%)',
      pattern:
  ...
  },
  {
    ...
    visual: {
      gradient:
        'linear-gradient(135deg, #4C1D95 0%, #DB2777 40%, #FB923C 100%)',
      pattern:
      ...
      <div className="page-shell flex flex-col gap-16">
        ...
        >
          ...
          <p className="max-w-3xl text-balance text-[1.125rem] leading-[1.6] text-white/70">
            Desde e-commerce y plataformas SaaS hasta experiencias inmersivas.
            Cada proyecto está diseñado para generar valor tangible y construir
            marcas memorables.
          </p>
        </header>
            ...
            >
              <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
                ...
                <div className="lg:col-span-5">
                  <div className="relative mx-auto w-full max-w-[440px] aspect-[16/9] overflow-hidden rounded-[1.75rem] border border-white/10 bg-[rgba(8,12,22,0.85)] p-0">
                    <div
                    ...
                    {project.visual.image && (
                      <img
                        ...
                        className="absolute inset-0 w-full h-full object-cover z-10 rounded-[1.75rem] border border-white/10"
                      />
                    )}
                  </div>
                </div>
        ...
        >
          <div className="flex flex-col gap-6 pb-6 text-center lg:flex-row lg:items-end lg:justify-between lg:text-left">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-white/70">
                Una selección de lanzamientos donde el énfasis estuvo en
                consistencia UX, performance y escalabilidad.
              </p>
            </div>
            <a
